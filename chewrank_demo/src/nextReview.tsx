  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <div
          className="ml-4 mt-[2px] flex shrink-0 w-[120px] flex-col truncate leading-[15px] duration-0"
          style={{
            visibility: restaurant ? "hidden" : "visible",
          }}
        >
          <div className="truncate shrink text-[13px] font-black">
            {data.hot[i]?.restaurantName}
          </div>
          <div className="flex flex-row text-[10px] font-bold opacity-50">
            <div className="shrink truncate">{data.hot[i]?.category}</div>
            <div className="mx-1">•</div>
            <div className="">{data.hot[i]?.distance}</div>
            <div className="mx-0.5 truncate shrink">mil</div>
          </div>
        </div>
        <div
